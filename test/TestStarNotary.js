...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    // 3. Verify if you Star name is the same
        let instance = await StarNotary.deployed();
        let starId = 9;
        await instance.createStar("awsome star", starId, {from: accounts[0]});
        assert.equal(await instance.lookUptokenIdToStarInfo(starId, {from: accounts[0]}), await instance.tokenIdToStarInfo.call(starId));
});